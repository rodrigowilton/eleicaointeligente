...
class Meta(models.Model):  # Renomeado para um nome mais apropriado
...
class StatusContato(models.Model):  # Renomeado para seguir o padrão de nomenclatura
    status_do_contato = models.CharField(max_length=60)

    def __str__(self):
        return self.status_do_contato
